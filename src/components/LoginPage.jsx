...
const LoginPage = () => {
    ...
    return (
        <div className="bg-green_yellow_backgroung flex flex-row justify-start items-start w-1920 h-1024 p-0 box-border overflow-hidden">
            <div className="absolute flex-col p-0 box-border left-0 right-0 top-0 bottom-0 mx-auto flex justify-center items-center w-601 h-620 top-190">                <img src={LogoImage} alt="logo" className="h-auto w-250.76 my-0" />
